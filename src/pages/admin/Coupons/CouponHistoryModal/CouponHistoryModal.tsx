...
import { useGetCouponHistoriesQuery } from '../coupon.service';
...
const CouponHistoryModal: React.FC<CouponHistoryModalProps> = ({ couponId, isOpen, onClose }) => {
  const [currentPage, setCurrentPage] = useState(1);
  const [pageSize, setPageSize] = useState(10);

  const { data: historyData, isFetching: isHistoryFetching } = useGetCouponHistoriesQuery({
    couponId,
